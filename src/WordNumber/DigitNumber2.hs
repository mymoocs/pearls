{--
  ...
  Last Modified : 2016 Dec 21 (Wed) 08:25:31 PM by Arthur Vardanyan.
--}
...
module WordNumber.DigitNumber2 where

import WordNumber.DigitNumber1
...
-- | every character maps to an element of this seminearring.
